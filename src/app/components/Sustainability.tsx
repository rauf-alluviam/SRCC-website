...
export default function SustainabilityDashboard() {
  ...
  return (
   <section className="relative w-full bg-gradient-to-b from-gray-50 via-white to-gray-100 overflow-hidden">
  {/* Hanging Container - Desktop Only */}
  <motion.img
    src="/hangingcontainer.png"
    alt="Hanging Container"
    className="hidden md:block absolute top-10 right-16 w-72 opacity-90 pointer-events-none"
    animate={{ y: [0, 15, 0], rotate: [0, 2, -2, 0] }}
    transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
  />

  {/* Heading + Mobile Hanging Container */}
  <div className="max-w-7xl mx-auto px-6 text-center mb-20 relative z-10  md:pt-24">
    {/* Mobile Hanging Container - shows below text naturally */}
    <motion.img
      src="/hangingcontainer.png"
      alt="Hanging Container"
  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
    {stats.map((stat, i) => {
      ...
      return (
        <motion.div
          key={i}
          className="relative backdrop-blur-xl bg-white/10 rounded-3xl shadow-lg p-8 flex flex-col items-center border border-white/20 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-pointer"
        ...
        >
          ...
          <p className="text-gray-200 mt-2 text-center text-sm font-medium tracking-wide">
            {stat.label}
          </p>
